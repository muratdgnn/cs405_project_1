...
function getModelViewMatrix() {
    ...
    let total_Matrix = multiplyMatrices(translationMatrix, scalingMatrix);
    total_Matrix = multiplyMatrices(total_Matrix, rotation_X);
...
function getPeriodicMovement(startTime) {
    ...
    const period = 10; // Total cycle time in seconds
    const phaseTime = elapsed % period; // Time within the current cycle
    let t = phaseTime < 5 ? (phaseTime / 5) : (2 - (phaseTime / 5)); // 0 to 1 in first 5 seconds, then 1 to 0 in last 5 seconds
